...
python test_iso.py --envname Hopper-v1 --t 500 --iters 5 10 15 20 --scale 1.0
...
python test_iso.py --envname Walker2d-v1 --t 500 --iters 5 10 15 20 --scale 1.0
...
python test_iso.py --envname HalfCheetah-v1 --t 500 --iters 5 10 15 20 --scale 1.0
...
python test_iso.py --envname Humanoid-v1 --t 500 --iters 50 100 150 200 --scale 1.0
