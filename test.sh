...
python experiments/test_dagger --envname Humanoid-v1 --t 500 --iters 50 100 150 200 --beta .5
...
python experiments/test_rand.py --envname Humanoid-v1 --t 500 --iters 50 100 150 200 --trace 0.05
