...
python experiments/plot_reward.py --env Hopper-v1 --t 500 --iters 5 10 15 20 --update 1 7 --save
...
# python experiments/plot_reward.py --env Walker2d-v1 --t 500 --iters 5 10 15 20 --update 1 7 --save
...
# python experiments/plot_reward.py --env HalfCheetah-v1 --t 500 --iters 5 10 15 20 --update 1 7 --save
...
# python experiments/plot_reward.py --env Humanoid-v1 --t 500 --iters 50 100 150 200 --update 60 75 90 105 120 135 150 165 180 195 --save --normalize
